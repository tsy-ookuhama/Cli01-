sap.ui.define([ 
	...
	return BaseController.extend("zbrlogu000001.controller.ObjectOF2", {
		...
		onInit : function () {
		    ...
		    var target = router.getTarget("objectOF2");
		...
		onPressConfirm : function() {
			...
			var oUrl = 
				"/sap/opu/odata/sap/ZBRLOG_COCKPITPORTARIA_ACTION_SRV/Action(IpEventCode='Z04',IpTorid='" 
			...
			var aData = jQuery.ajax({
				...
				success: function(data, textStatus, jqXHR) {
					oModel.setData(data);
					MessageToast.show("Confirmação da Saída sendo processada", {
						duration: 100000
					});
				},
